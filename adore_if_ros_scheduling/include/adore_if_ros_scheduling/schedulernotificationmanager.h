...
namespace adore_if_ros_scheduling
{
  ...
  public:
    ...
    {
      m_clientNameWriter = m_pN->advertise<std_msgs::String>(TOPIC_NAME_CLIENT_NAME, 1);
      m_notificationWriter = m_pN->advertise<adore_if_ros_scheduling::SchedulerNotification>(TOPIC_NAME_SCHEDULIER_NOTIFICATION, 1);
