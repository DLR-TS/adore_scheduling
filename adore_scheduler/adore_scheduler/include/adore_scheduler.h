    ...
    private:
        ...
        Scheduler(ros::NodeHandle &n, int minRegisters, bool autostart, bool tcp_no_delay)
        {
            ...
            m_notificationReader =
                n.subscribe(adore_if_ros_scheduling::TOPIC_NAME_SCHEDULER_NOTIFICATION, 1000, &Scheduler::updateClientUpperTimeLimit, this,
                            ros::TransportHints().tcpNoDelay(tcp_no_delay));
            m_clientNameReader = n.subscribe(adore_if_ros_scheduling::TOPIC_NAME_CLIENT_NAME, 1000, &Scheduler::saveClientName, this,
                                             ros::TransportHints().tcpNoDelay(tcp_no_delay));
            m_simulationTimeWriter = n.advertise<std_msgs::Float64>(adore_if_ros_scheduling::TOPIC_NAME_SIMULATION_TIME, 1);
            m_clockTimeWriter = n.advertise<rosgraph_msgs::Clock>(adore_if_ros_scheduling::TOPIC_NAME_CLOCK_TIME, 1);
