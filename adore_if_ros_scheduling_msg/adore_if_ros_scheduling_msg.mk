...
ifeq ($(filter adore_if_ros_scheduling_msg.mk, $(notdir $(MAKEFILE_LIST))), adore_if_ros_scheduling_msg.mk)
...
ifeq ($(SUBMODULES_PATH),)
    ADORE_IF_ROS_SCHEDULING_MSG_SUBMODULES_PATH:=${ADORE_IF_ROS_SCHEDULING_MSG_MAKEFILE_PATH}/..
else
    ADORE_IF_ROS_SCHEDULING_MSG_SUBMODULES_PATH:=$(shell realpath ${SUBMODULES_PATH})
endif
MAKE_GADGETS_PATH:=${ADORE_IF_ROS_SCHEDULING_MSG_SUBMODULES_PATH}/make_gadgets
ifeq ($(wildcard $(MAKE_GADGETS_PATH)/*),)
    ...
    $(info INFO: Default submodule path is: ${ADORE_IF_ROS_SCHEDULING_MSG_MAKEFILE_PATH}')
...
ADORE_IF_ROS_SCHEDULING_MSG_CMAKE_BUILD_PATH="${ADORE_IF_ROS_SCHEDULING_MSG_PROJECT}/build"
ADORE_IF_ROS_SCHEDULING_MSG_CMAKE_INSTALL_PATH="${ADORE_IF_ROS_SCHEDULING_MSG_CMAKE_BUILD_PATH}/install"
...
build_adore_if_ros_scheduling_msg: ## Build adore_if_ros_scheduling_msg
	cd "${ADORE_IF_ROS_SCHEDULING_MSG_MAKEFILE_PATH}" && make build
