...
class SchedulerNotification {
 public:
  ...
  uint32_t getUpperTimeLimitSec() const { return m_upperTimeLimitSec; }
  uint32_t getUpperTimeLimitNsec() const { return m_upperTimeLimitNsec; }
  ...
  unsigned int getID() const { return m_msg->identifier; }
  void setID(unsigned int id) { m_msg->identifier = id; }
